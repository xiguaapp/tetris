...
namespace 俄罗斯方块
{
    class L_LeftBox:Cell
    {
         public L_LeftBox() 
        {
            style1[0, 1] = style1[1, 1] = style1[2, 0] = style1[2, 1] = 1;
            style2[0, 0] = style2[0, 1] = style2[0, 2] = style2[2, 1] = 1;
            style3[0, 0] = style3[0, 1] = style3[1, 0] = style3[2, 0] = 1;
            style4[0, 0] = style4[1, 0] = style4[1, 1] = style4[1,2]=1;
            base.Initial = style1;
        }
