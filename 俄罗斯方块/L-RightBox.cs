...
namespace 俄罗斯方块
{
    class L_RightBox:Cell
    {
        //这里有问题！
        public L_RightBox()
        {
            style1[0, 0] = style1[1, 0] = style1[2, 0] = style1[2, 1] = 1;
            style2[0, 2] = style2[1, 0] = style2[1, 1] = style2[1, 2] = 1;
            style3[0, 0] = style3[0, 1] = style3[1, 1] = style3[2, 1] = 1;
            style4[0, 0] = style4[0, 1] = style4[0, 2] = style4[1, 0] = 1;
            base.Initial = style1;
        }
